...
`ext/` groups Waytide's extensions and externals and is not a package. `ext/ruby-lang` is the package. The grouping was `tools/` until 2026-08-23.
...
```
ext/ruby-lang    →  foundation, language, testing, git,
...
```
git subtree add  --prefix waytide/system/ext/ruby-lang git@github.com:waytide/waytide-ruby.git master --squash
git subtree pull --prefix waytide/system/ext/ruby-lang git@github.com:waytide/waytide-ruby.git master --squash
```

Then `waytide/system/ext/ruby-lang/install-dependencies.sh` from your project root, which installs the seven packages this one includes.
