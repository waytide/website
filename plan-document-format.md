...
**Two sections were removed on 2026-08-03, and the reason is the same for the two: neither belonged to a plan.** **Commit policy** restated which of the `git` package's conventions applied. That is a second place to keep true, and the package's own concern. The rule said as much while asking for the section anyway. **Tech Stack** was one line answering a question a project answers once, not per plan.
