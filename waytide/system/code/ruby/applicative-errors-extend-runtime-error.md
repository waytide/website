...
An **applicative error** extends **`RuntimeError`**, and extends it **directly**. It is an
error class the library defines for its own failures, as distinct from one the platform
raises.
