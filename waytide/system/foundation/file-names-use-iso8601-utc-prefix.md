...
- The **working-state** directories: the running records under `logs/` — the decision log (`logs/log/`), `logs/loops/`, and `logs/work-sessions/` — and the work-artifact directories `ideas/`, `implementations/`, and `migration/`.
